...
![/create_application panel](/img/list.png)
...
| Passed Application Role | The role given to people who passed their application. |
| Failed Application Role | The role given to people who failed their application. |
| Applied Role | The role given to people who have applied. |
| Questions List | List of questions. |

:::warning Log Channel Required
The log channel must be filled to create the application.
:::
...
![/create_application dropdown](/img/dropdown.png)
...
## How to Edit or Remove Applications
